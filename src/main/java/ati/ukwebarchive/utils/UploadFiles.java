...
/**
 * This class uploads files from a local directory to a blobs container
 *
 * @author pierpaolo
 */
public class UploadFiles {

    private static final Logger LOG = Logger.getLogger(UploadFiles.class.getName());

    /**
     * args[0]=blob container URI, args[1]=blob container prefix, args[2]=local
     * directory, args[3]=file extension
     *
